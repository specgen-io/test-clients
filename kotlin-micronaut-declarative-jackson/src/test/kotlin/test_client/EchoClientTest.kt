...
class EchoClientTest {
    ...
    fun echoSuccess_ok() {
        ...
        val response = EchoSuccessResponse.create(json, echoClient.echoSuccess("ok"))
        assertThat(expected).usingRecursiveComparison().isEqualTo(response)
    }
    ...
    fun echoSuccess_created() {
        ...
        val response = EchoSuccessResponse.create(json, echoClient.echoSuccess("created"))
        assertThat(expected).usingRecursiveComparison().isEqualTo(response)
    }
    ...
    fun echoSuccess_accepted() {
        ...
        val response = EchoSuccessResponse.create(json, echoClient.echoSuccess("accepted"))
        assertThat(expected).usingRecursiveComparison().isEqualTo(response)
    }
}
